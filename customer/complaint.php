        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="nav flex-column nav-pills me-3 profile-card" id="v-pills-tab" role="tablist"
                    ...
                    <button class="nav-link profile-tab <?= $currentTab == 'submit' ? 'active' : ''; ?>" id="submit-tab"
                        data-bs-toggle="pill" data-bs-target="#complaint-submit" type="button" role="tab"
                        aria-controls="complaint-submit"
                ...
                <div class="tab-content profile-card" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade <?= $currentTab == 'submit' ? 'show active' : ''; ?>"
                        ...
                        <form method="POST" action="complaint.php" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="attachment" class="form-label">Bukti Pendukung (Foto/Video,
                                    Opsional)</label>
                            ...
                            <button type="submit" class="btn btn-update-profile mt-3"><i
                                    class="fas fa-paper-plane me-2"></i> Kirim Komplain</button>
                        </form>
                    </div>
                                    ...
                                    <div class="accordion-item mb-2">
                                        ...
                                        <div id="collapse<?= $complaint['id']; ?>" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p class="mb-1 text-muted">Tanggal Pengajuan:
